...
'''
python3.6 train_sgn.py --select_sigma all --gpu --gpu_id 0 --tail_conv 1
'''
...
def main():
    ...
    model = Grad_sgn.GRAD(feats=args.feats, basic_conv=args.basic_conv, tail_conv=args.tail_conv).to(device)
