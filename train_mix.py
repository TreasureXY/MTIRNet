...
'''
python3.6 trainx.py --select_sigma all --tail_conv 1 --gpu --gpu_id 0
'''
...
def main():
    ...
    model = Grad_mix.GRAD(feats=args.feats, basic_conv=args.basic_conv, tail_conv=args.tail_conv).to(device)
